...
oauth_applications_client_type_label :: Form label for the oauth application client type.
oauth_applications_confidential_label :: Form label for a confidential oauth application.
oauth_applications_public_label :: Form label for a public oauth application.
...
oauth_application_client_type_label :: Labels a client application as public or confidential.