...
oauth_saml_cert_fingerprint :: SAML certificate fingerprint
oauth_saml_cert_fingerprint_algorithm :: SAML certificate fingerprint algorithm (<tt>nil</tt> by default).
oauth_saml_name_identifier_format :: SAML name ID format.
