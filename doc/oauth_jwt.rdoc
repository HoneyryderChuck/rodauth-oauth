...
oauth_application_jwt_public_key_param :: Form paramm for the oauth application client application public key.
...
oauth_jwt_keys :: collection of the auth server signing keys indexed by algo, **must** include <tt>oauth_jwt_key</tt>.
