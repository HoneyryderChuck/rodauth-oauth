...
class RodauthOAuthHTTPMacAuthorizeTest < HTTPMacIntegration
  def test_http_mac_authorize_post_authorize_with_implicit_grant_sha256
    rodauth do
  ...
  def test_http_mac_authorize_post_authorize_with_implicit_grant_sha1
    rodauth do
      oauth_mac_algorithm "hmac-sha-1"
      use_oauth_implicit_grant_type? true
    end
    setup_application
